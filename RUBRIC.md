...
- **2026-08-04a:** Immich download/partner/datetime + Next.js useParams + Bruno splitscreen + HA Fireangel - 6/6 core-host or device-driver. Photo-library + framework + desktop-client + HA hardware still host-saturated.
