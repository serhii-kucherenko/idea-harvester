...
- **2026-07-29r:** API-client expand (Scalar/HTTPie/Postman): 14/14 core-host. HTTPie #222 sync request strengthens multi-client collection-sync demand without being a new card. Prefer OUTREACH sends over more client-tracker expands.
